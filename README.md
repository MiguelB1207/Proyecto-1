...
4. Despues de que la descarga haya sido exitosa abrimos el archivo con el siguiente codigo, py -3.13 "proyecto.py", EN MI CASO LA VERSION DE PYTHON ES LA 3.13.
5. El codigo generara los archivos cvc en la carpeta donde tenemos el proyecto y podremos analizarlas y volverlas a generar.
